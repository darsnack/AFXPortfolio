...
ofile_name = afx_ofilename('pitch-shifting', file_name, output_folder, 'wav', ...
                            {{'scale_factor' scale_factor ''}});
audio_writer = dsp.AudioFileWriter(ofile_name, 'SampleRate', scale_factor * audio_reader.SampleRate);
